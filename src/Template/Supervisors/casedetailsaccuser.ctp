    ...
    <?php $url8= $this->Url->build(['controller' => 'Supervisors', 'action' => 'employee_records']);?>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="hidden-sm hidden-md hidden-lg"><a href="<?= $url6?>">Panel Formation</a></li>
    ...
    <div class="row">
        <div class="col-sm-2 hidden-xs">
            <div class="fixed-side-pane">
                <ul>
                    <li class="active"><a href="case-details-accuser.html">Accuser</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="panel-block" style="background:none;">
                    <div class="row panel-block-row panel-block-row-link">
                        ...
                        <div class="col-md-7"><p class="panel-block-label">STE659874560</p></div>
