    ...
    <?php $url8= $this->Url->build(['controller' => 'Supervisors', 'action' => 'employee_records']);?>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="hidden-sm hidden-md hidden-lg"><a href="<?= $url7?>">Submit Form</a></li>
        ...
        <div class="col-sm-2 hidden-xs">
            <div class="fixed-side-pane">
                <ul>
                    ...
                    <li class="active"><a href="<?= $url4?>">Nature of Accusation</a></li>
                    <li><a href="<?= $url5?>">Personal Notes</a></li>
