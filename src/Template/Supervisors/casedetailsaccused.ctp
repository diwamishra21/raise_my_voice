        ...
        <div class="col-sm-2 hidden-xs">
            <div class="fixed-side-pane">
                <ul>
                    ...
                    <li class="active"><a href="<?= $url2?>">Accused</a></li>
        ...
        <div class="col-sm-10">
            ...
            <div class="container-fluid">
                <div class="bg-transparent margin-bottom-30">
                    <h3 class="panel-block-label">Accused Details</h3>
                </div>
            ...
            <div class="container-fluid">
                <div class="panel-block">
                    <div class="row">
                        <?= $this->Form->create('Users',['url' => ['controller' => 'Users', 'action' => 'casedetailsaccused']]); ?>
                        <div class="col-md-6">
