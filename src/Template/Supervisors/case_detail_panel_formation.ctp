        ...
        <div class="col-sm-2 hidden-xs">
            <div class="fixed-side-pane">
                <ul>
                    ...
                    <li class="active"><a href="<?= $url6?>">Panel Formation</a></li>
                        ...
                        <div class="col-md-6">
                            <div class="form-group"></br>
                                <label for="scribe">Scribe</label>
                                    <?php $scribe=array('Yes'=>'Yes','No'=>'No'); 
echo $this->Form->select('scribe',$scribe,['class'=>'form-control','id'=>'scribe','label' => 'Scribe','empty'=>'Choose an option']); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 text-right">
                            <button type="button" class="btn btn-dark">+ Add Panelist</button>
                        </div>
                    </div>
                </div>
            </div>
