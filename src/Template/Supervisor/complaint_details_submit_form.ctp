...
<?php $ComplaintDetailsCloseForm=$this->Url->build(['controller'=>'Supervisor','action'=>'ComplaintDetailsCloseCase',$id]);?>  
   ...
   <li><a href="<?php echo $witness_url ;?>">Witnesses</a></li>
                    ...
                    <li class="active"><a href="<?= $ComplaintDetailsSubmitForm ; ?>">Submit Form</a></li>
                </ul>
 ...
 <?php   endforeach; ?>
            ...
            <div class="container-fluid">
                <div class="panel-block margin-bottom-30">
                    <p>The application along with the report filed by the accuser will now be forwarded to the HR committee.</p>
                    <p>Please make sure you have reviewed all the necessary information, documents and personnel involved before you submit this application.</p>
                    <div class="margin-top-60 text-right">
                         <a href="<?= $ComplaintDetailsCloseForm; ?>" class="btn btn-dark">Submit Report</a>
                    </div>
                </div>
            </div>
        </div>
