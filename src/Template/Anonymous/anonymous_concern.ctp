...
<!--                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                             <label for="captcha"></label>
                             <input type="text" name="CaptchaInput" id="CaptchaDiv" size="15" style="font: bold 25px verdana, arial" onchange="ValidCaptcha()" class="form-control" width="48" height="48"  disabled="disabled">
