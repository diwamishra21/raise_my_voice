...
<div class="container-fluid margin-top-60">
    <div class="container-fluid p-a-20 text-center m-t-30">
        <div class="col-md-6 col-md-offset-3">
            ...
            <p class="text-justify">If you still wish to remain anonymous, you may continue as a guest user or sign in using your employee username and password. Please note, even if you file a case anonymously, we might still need to reach out to you to get more information and hence the email ID will be a mandatory field for the complaint to be registered. </p>
            <hr/>
