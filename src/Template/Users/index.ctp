    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('bu') ?></th>
                <th scope="col"><?= $this->Paginator->sort('department') ?></th>
                <th scope="col"><?= $this->Paginator->sort('city') ?></th>
                <th scope="col"><?= $this->Paginator->sort('work_location') ?></th>
                <th scope="col"><?= $this->Paginator->sort('policy_agreed') ?></th>
                <th scope="col"><?= $this->Paginator->sort('first_access') ?></th>
                <th scope="col"><?= $this->Paginator->sort('last_access') ?></th>
                <th scope="col"><?= $this->Paginator->sort('lastip') ?></th>
