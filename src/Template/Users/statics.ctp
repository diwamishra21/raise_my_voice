...
<head>
    ...
    <!-- Bootstrap -->
     <?php $this->Html->link('css/bootstrap.css')?>
    <?php $this->Html->link('js/custom.js')?>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="hidden-sm hidden-md hidden-lg"><a href="messages.html">Messages</a></li>
        ...
        <div class="col-sm-10">
            <div class="container-fluid">
                <div class="panel-block bg-transparent" id="reports">
                    <h2 class="panel-block-title">Statistics</h2>
                </div>
