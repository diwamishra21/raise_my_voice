...
<h5 style="color:red;padding-bottom:20px;"> <?= $this->Flash->render('flash', [
    'element' => 'login_error'
]); ?>  </h5> 
 ...
 <span id="check_password" style="color:red"></span>                                         
					...
					<div class="form-group p-t-10">
                       <?php echo $this->Form->input('Sign In',['type'=>'submit','id'=>'btn-login','placeholder'=>'','class'=>'btn btn-default btn-dark btn-block']);?>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="p-t-5">
                                <?php $forgotpassword= $this->Url->build(['controller' => 'Users', 'action' => 'forgotpassword']);?>
                                    <small class="text-muted"><a href="<?= $forgotpassword ?>">Forgot Password?</a></small>
                                </div>
                            </div>
                            <div class="col-xs-6">
					...
					<?php $url2= $this->Url->build(['controller' => 'Anonymous', 'action' => 'anonymousConfirmation']);?>
                        <a href="<?= $url2 ;?>" style="background-color: #e23d40" class="btn btn-default btn-dark btn-block">Go Anonymous</a>
                    </div>
