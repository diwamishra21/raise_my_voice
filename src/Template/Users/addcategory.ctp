...
<head>
    ...
    <![endif]-->
 <?php $clientname = $this->Url->build(['controller'=>'Users','action'=>'clientName']); ?>
</head>
<body>
            ...
            <div class="container-fluid" id="concern-form">
                <div class="concern-form-section active">
                    <div class="panel-block bg-transparent">
                        <h2 class="panel-block-title">Add Category</h2>
                    </div>
                    ...
                    <div class="panel-block">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="subject_city">Name<span style="color: red">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="category_status">Status<span style="color: red">*</span></label>
                            ...
                            <div class="col-md-12 text-right">
                                <div class="form-group">
                                   ...
                                   <a href="<?= $addsubcategory;?>" class="btn btn-dark p-a-10"></i>Cancel</a>
                                    <button  class="btn btn-dark p-a-10" id="btn-category"> Add </button>
                                </div>
                            </div>
                        </div>
                    </div>
 ...
 $(document).ready(function () {
    $('#btn-category').click(function(){
     ...
     if($('#cat_name').val()=="")
     {
        ...
        $('#check_cat_name').text('Please enter category ');
     ...
     {
        alert("Catergory added sucessfully");
        return true;
     }
