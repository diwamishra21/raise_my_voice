...
<div class="container-fluid margin-top-60">
 ...
 <?php   endforeach; ?>
                ...
                <div class="panel-block bg-transparent">
                    <div class="row panel-block-row panel-block-row-link">
                        <div class="col-md-2">
   <?= $this->Form->create('Users',['url' => ['controller' => 'Users', 'action' => 'complaintDetails']]);?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="6" id="rejection_reason" name="rejection_reason" required></textarea>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-dark">Reject Case</button>
            </div>
        </div>
    </div>
</div>
