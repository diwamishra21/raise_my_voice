    ...
    <div class="container-fluid p-a-20 text-center m-t-30">
        <div class="col-md-6 col-md-offset-3">
			...
			<div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group margin-bottom-30">
					<?php $signup= $this->Url->build(['controller' => 'Users', 'action' => 'signup']);?>
                        <a href="<?= $signup;?>" class="btn btn-default p-a-10">Sign Up</a>
                    </div>
                </div>
            </div>
			...
			<?php $url2= $this->Url->build(['controller' => 'Anonymous', 'action' => 'anonymousConcern']);?>
                <a href="<?= $url2 ?>" class="btn btn-dark p-a-10">Stay Anonymous</a>
            </div>
        </div>
    </div>
