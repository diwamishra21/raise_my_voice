    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="hidden-sm hidden-md hidden-lg"><a href="#">Registered Concerns</a></li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Hello, <?php foreach ($user_deatil as $user_deatils): 
					    endforeach; ?>
                             <?= h($user_deatils->username) ?><span class="caret"></span></a>
