...
<?php $witness_url=$this->Url->build(['controller'=>'Supervisor','action'=>'ComplaintDetailsWitness']);?>   
                   <li><a href="<?= $accuser_url;?>">Accuser</a></li>
                      <li><a href="case-details-accused.html">Accused</a></li>
   <li><a href="<?php $witness_url ;?>">Witnesses</a></li>
                    <li class="active"><a href="<?php echo $accusation_url; ?>">Nature of Accusation</a></li>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="category">Category</label>
                                    <?php $category=array('Harassment'=>'Harassment','Disciplinary'=>'Disciplinary','Business Ethics'=>'Business Ethics'); 
echo $this->Form->select('category',$category,['class'=>'form-control','id'=>'category','label' => 'Category','empty'=>'Choose an option']); ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
